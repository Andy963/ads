...
const messages = computed<ChatMessage[]>(() => {
  ...
  return [
    ...
    { id: "e-2", role: "system", kind: "execute", content: longOutput, command: "cat /var/log/example.log | tail -n 200 | sed -n '1,120p'" },
    { id: "e-3", role: "system", kind: "execute", content: "", command: "echo no output" },
...
<template>
  <div class="fixture">
    <div class="fixtureHeader">
      ...
      <div class="fixtureHint">Stacked blocks should not change the outer block height.</div>
